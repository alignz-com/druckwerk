...
export function UserCreateDialog({ open, onOpenChange, brandOptions, onCreated }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={(next) => {
      ...
      <DialogContent className="max-w-lg p-0 flex flex-col max-h-[90vh]">
        ...
        <form className="flex flex-col flex-1 overflow-y-auto" onSubmit={handleSubmit}>
