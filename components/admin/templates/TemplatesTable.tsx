              ...
              <TableHead>
                <DataTableColumnHeader
                  column={{
                    ...
                    toggleSorting: (desc) =>
                      setSort((current) => {
                        if (!current || current.id !== "label") return { id: "label", direction: desc ? "desc" : "asc" };
                        if (current.direction === "asc") return desc ? { id: "label", direction: "desc" } : current;
              ...
              <TableHead>
                <DataTableColumnHeader
                  column={{
                    ...
                    toggleSorting: (desc) =>
                      setSort((current) => {
                        if (!current || current.id !== "brands") return { id: "brands", direction: desc ? "desc" : "asc" };
                        if (current.direction === "asc") return desc ? { id: "brands", direction: "desc" } : current;
                        if (current.direction === "desc") return desc ? current : null;
            ...
            {pageData.length === 0 ? (
              ...
              pageData.map((row) => (
                ...
                >
                  ...
                  <TableCell>
                    <span className={row.assetStatus.tone === "warning" ? "text-xs font-medium text-amber-600" : "text-xs font-medium text-emerald-600"}>
