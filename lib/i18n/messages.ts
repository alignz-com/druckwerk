...
export const messages = {
  en: {
    ...
    deliveriesPage: {
      title: "Deliveries",
      subtitle: "Bundle orders into a delivery and generate a delivery note.",
      table: {
        ...
        noResults: "No deliveries match your filters.",
      },
      detail: {
        title: "Delivery",
        note: "Note",
        created: "Created",
        download: "Download delivery note",
  ...
  de: {
    ...
    deliveriesPage: {
      title: "Lieferungen",
      subtitle: "Fasse Bestellungen zu einer Lieferung zusammen und erstelle einen Lieferschein.",
      table: {
        searchPlaceholder: "Lieferungen durchsuchen…",
        number: "Liefer-Nr.",
        created: "Erstellt",
        orders: "Bestellungen",
        note: "Notiz",
        pdf: "Lieferschein",
        empty: "Noch keine Lieferungen vorhanden.",
        noResults: "Keine Lieferungen passen zu deinen Filtern.",
      },
      detail: {
        title: "Lieferung",
        note: "Notiz",
        created: "Erstellt",
        download: "Lieferschein herunterladen",
