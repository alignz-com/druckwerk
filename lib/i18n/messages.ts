    ...
    admin: {
      ...
      templates: {
        ...
        detail: {
          ...
          fonts: {
            assignHeading: "Assign font families",
            assignDescription: "Link one or more font families so the preview and PDF can use every variant.",
            ...
            removeConfirm: "Remove all variants of {name}?",
            ...
            defaultsHeading: "Default font roles",
            defaultsDescription: "Pick which linked variant should be used for regular, bold, and italic text when rendering.",
            defaultsEmpty: "Link at least one font before assigning defaults.",
            defaultsUpdated: "Font defaults updated.",
            defaultsFailed: "Failed to update font defaults.",
            defaults: {
    ...
    admin: {
      ...
      templates: {
        ...
        detail: {
          ...
          fonts: {
            assignHeading: "Font-Familien zuweisen",
            assignDescription: "Verknüpfe komplette Font-Familien, damit Vorschau und PDF alle Varianten verwenden können.",
            searchPlaceholder: "Font-Familien durchsuchen…",
            empty: "Keine Font-Familien passen zu deiner Suche.",
            assignFamily: "Familie zuweisen",
            ...
            removeConfirm: "Alle Varianten von {name} entfernen?",
            ...
            defaultsHeading: "Standard-Font-Rollen",
            defaultsDescription: "Lege fest, welche Variante für Regular, Bold und Italic beim PDF-Rendering genutzt wird.",
            defaultsEmpty: "Bitte zuerst einen Font verknüpfen.",
            defaultsUpdated: "Font-Standards aktualisiert.",
            defaultsFailed: "Font-Standards konnten nicht gespeichert werden.",
            defaults: {
              placeholder: "Kein Standard vergeben",
              labels: {
                regular: "Regular",
                bold: "Bold",
                italic: "Italic",
