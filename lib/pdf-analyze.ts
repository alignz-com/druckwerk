/**
 * Shared PDF analysis: dimensions, bleed, pages, colors, thumbnails.
 * Extracted from app/api/pdf-process/route.ts for reuse in API ingest.
 */
...
/**
 * Analyze a PDF buffer: extract dimensions, bleed, pages, colors, and thumbnail.
 */
